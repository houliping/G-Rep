...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox_init=dict(type='WassersteinLoss', loss_weight=0.375),
        loss_bbox_refine=dict(type='WassersteinLoss', loss_weight=1.0),
...
train_cfg = dict(
    init=dict(
        ...
        debug=False),
    refine=dict(
        assigner=dict(type='ATSSWtdAssigner', topk=9),
        allowed_border=-1,
        pos_weight=-1,
        debug=False))
