...
class ATSSBcdAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        overlaps = self.bcd_overlaps(gt_bboxes, bboxes)  # (gt_bboxes, points)
    ...
    def bcd_overlaps(self, gt_rbboxes, points):
        ...
        # overlaps = 1/(0.5+torch.log(1+bcd))
        # overlaps = 1 / (2 + torch.sqrt(bcd))
        # overlaps = 1/(1+torch.log(bcd+1))
        return overlaps
